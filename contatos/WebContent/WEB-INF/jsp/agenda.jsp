...
$(document).ready(function(){
	...
	$("#adicionar").click(function(){
		$("#div2").html("<form><table><tr><td>id:<input id=\"idContato\" type=\"text\"></td></tr><tr><td>Nome do contato:<input id=\"nomeContato\" type=\"text\"></td></tr>"+
		...
		"</td></tr><tr><td>Ddd:<input id=\"dddContato\" type=\"text\"></td></tr><tr><td>Tipo:<input id=\"tipo\" type=\"text\"></td></tr><tr><td><button id=\"send\">submeter</button></td></tr></table></form>");		
			$.post("rota",{classe:"BuscarIdDono",email:sessionStorage.getItem("EMAIL")},function(responseTxt){
				$("#idContato").val(responseTxt);
			    $("#send").click(function(){
				$.post("rota",{classe:"AdicionarContatos",
					idContato:$("#idContato").val(),
		            nomeContato:$("#nomeContato").val(),
		            telContato:$("#telContato").val(),
